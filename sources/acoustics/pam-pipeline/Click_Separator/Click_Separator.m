function Separated_whales=Click_Separator(Sig,Click_detections,P,Fs,Plot_flag)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [trajectories,id_j_ToAs]=run_train(Sig,Detections,Fs,P,Plot_flag);

    %% Association of click trains

    Separated_whales=run_trains_association_algo(trajectories,id_j_ToAs,Sig,Fs,P,Plot_flag);
