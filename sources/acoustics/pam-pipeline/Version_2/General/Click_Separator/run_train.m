function [trajectories,id_clicks]=run_train(Detections,Fs,P,Plot_flag)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:length(Detections) 
        ...
        for j=1:length(Detections(i).ICI)
            ...
            id_j_Slant_delays(co_1)=Detections(i).ref(j);
    ...
    if isempty(transition_arcs)
        ...
        if Plot_flag.Click_separation
            ...
            for j=1:length(trajectories)
                ...
                Slant=cell2mat(id_j_Slant_delays(trajectories{j}));  
                subplot(2,2,4);
    ...
    id_clicks.Slant_delays=id_j_Slant_delays;
end