...
%   > P.MPS_max                - Scalar representing the maximum plausible IPI [in sec] of sperm whale clicks
%   > P.IPI_min                - Scalar representing the minimum plausible IPI [in sec] of sperm whale clicks
%   > P.edge_width             - Scalar representing a window [in sec] set to avoid numerical issues near edges of analysis windows
